    ...
    <DashboardLayout>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <StatsCard 
          ...
          value={livePRs.filter(p => !p.isDraft && p.state === "open").length.toString()} 
        ...
        <div className="lg:col-span-2 space-y-8">
          <section>
            <h2 className="text-xl font-semibold mb-4 flex items-center gap-2">
              Run Monitor 
              {hasLive && <span className="text-[10px] bg-green-100 text-green-700 px-2 py-0.5 rounded-full dark:bg-green-900/30 dark:text-green-400 font-bold uppercase tracking-widest">Live Enabled</span>}
            </h2>
